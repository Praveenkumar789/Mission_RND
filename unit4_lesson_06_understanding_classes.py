...
- I have learnt the classes and the default methods
-__init__() method acts as a constructor and all class parameters are the parameters foor the init function
- Also the class variables are defined using self where as normal variables are defined as normal also self refers to the instance of the class
"""