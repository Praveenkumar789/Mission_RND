...
def test_left_binary_search_student():
    assert 3 == left_binary_search([1,1,1,2,2,3,3],2)
    ...
    assert -1 == left_binary_search([2,3,4,5],7)
    assert -1 == left_binary_search([2,2,3,3,4,4,5],1)
    assert 0 == left_binary_search("1123456","1")
    assert 3 == left_binary_search("bbbccccc","c")
    assert 0 == left_binary_search((10,20,20,20,30,30,40,40,50),10)
    assert 1 == left_binary_search((10,20,20,20,30,30,40,40,50),20)
    assert 4 == left_binary_search((10,20,20,20,30,30,40,40,50),30)
    assert 6 == left_binary_search((10,20,20,20,30,30,40,40,50),40)
