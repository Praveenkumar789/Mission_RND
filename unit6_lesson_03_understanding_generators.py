...
def demo_generator_to_list(generator):
    return [ele for ele in generator] # fill code here.
...
- about generators and their working
- generators are internally iterators they allocate memory step by step not ata time
- generators are quiet useful when working with huge amountts of data
"""
