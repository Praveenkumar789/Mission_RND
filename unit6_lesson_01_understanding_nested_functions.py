...
- I have learnt that we can use 'nonlocal' before variable to access the global variables when the variable names are same
- I have learnt that Inner functions will bind to the latest call for it
- I have learnt that every invocation results in a new function and def is just a statement
"""
