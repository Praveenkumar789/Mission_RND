...
- When we import packages using 'import' keyword, only the Attributes under that can be accessed, we cannot access sub packages and modules in the main package
- When we import packages using 'import package.module', we can access both the packages as well as module of the package
- When we import packages using 'from package import module', only the module and its its Attributes are imported, we cannot access the main package Attributes 
"""
