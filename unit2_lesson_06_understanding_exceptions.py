...
- I have learnt about stack trace, which means an error if it occurs, the program will be terminated without further execution
- I have learnt about handling exceptions using try except blocks try checks for exceptions holds the risky code and except block catches the exceptions
- Control moves to else block if try block do not contain any errors , Code in finally block will be executed under any circumstances i.e even if there are few errors  
"""
