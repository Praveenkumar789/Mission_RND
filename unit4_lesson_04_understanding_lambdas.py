...
- I have learnt that that Lambda is just like a function, the syntax is 'lamda parameters:return value'
- Lambda can access the locals
- Lambda can be defined anywhere and called at that instance
"""