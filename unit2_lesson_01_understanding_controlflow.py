...
- I have learnt the control statements of python
- I have learnt that else: block after loops will execute only when the loops terminates normally 
- If a break statement is incurred, the content of else block will not be executed
"""