...
- I have learnt that in control flow , all empty data structures are treated as false
- White space and all non empty data structures are treated as true only in control flow
- while in generally they are not equal to true but 0 is equal to False and 1 is equal to True because they are internal binary representations of True and False
"""
