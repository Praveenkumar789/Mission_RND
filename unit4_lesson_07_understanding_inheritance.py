...
- I have learnt that the class which is to be inhereted is passed as an argument to the class which is going to inherit
- inorder to define the same variables of parent class, we call the __init__() method of parent class in the init method of child class
