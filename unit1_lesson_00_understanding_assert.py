...
def test_assert_true_with_message():
    print("test print")
    assert True, "Failed to assert" # what error do you see when you run this test?
...
-Assert is a keyword which will check or asserts the trueness of a statement
-The syntax for Asserting statement is assert <statement to experiment>,"Optional message"
- If true the test case will be passed and nothing prints else it return in an assertion error with optional message it it is there
"""