...
def get_lower_to_upper_dict():
    ...
    return dict(zip(Lowercase,Uppercase))
...
def get_encoding_dict():
    ...
    numbers = list(range(1,27))+list(range(1,27))
    diction = dict(zip(alphabets, numbers))
    return diction
...
def capitalize_names(input):
    ...
    """
    string =" "
    string = string.join(input).title()
    return string.split()
