...
- I have learnt the methods of list 
- I have learnt that lists are mutable unlike stings and tuples
- I have learnt that range() function itself a list with the limits we set
"""