...
import time
import unit8_conversion_methods as meths
...
def profile_perf_counter():
    funcs = [meths.numbers_string1, meths.numbers_string2, meths.numbers_string3, meths.num_strings4]
    for func in funcs:
        times = []
        for i in range(1,5):
            actuals = []
...
summary = '''
The bst way is to use the python builtin functions that is case 2 where we have used range and 
list comprehensions that worked well even with increasing the inputs 
