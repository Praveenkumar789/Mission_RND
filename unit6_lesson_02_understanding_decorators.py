...
def test_decorator_chaining():
    ...
    assert ['pt1', 'pt2', 'pt1', 'pt2'] == test_logs
...
- I have learnt that decorator act as the closures using them we can modify/ change the behavior of functions as per requirements 
- the syntax is @decaratorfunction_name which when places before a function will change the behavior to the inner function of the decorator function
