...
- sets can't contain duplicates, null values
- i have learnt the operations on sets 
- sets are more useful when dealing with complex data where duplicates and null values 
"""
