...
- I have learnt that namespace are the areas where the names are bound to
- There are two name spaces global and local
- Local names are those which are Inside the modules as well as inside functions/classes while Global are those which are inside modules but outside the functions/classes
"""
