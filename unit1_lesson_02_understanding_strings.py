...
def test_strings_can_be_indexed():
    ...
    try:
        ...
        print(ie)
        assert string[-5]==string[0]  #make this True to proceed.
...
def test_strings_are_immutable():
    ...
    try:
        ...
        print(te)
        assert string[0]=='H'   # after you observe, make this True to proceed.
...
def test_string_combine():
    ...
    hello = "Hello World"
    bye = "Goodbye moon"
    assert  bye[0:7] + hello[5:len(hello)]  == "Goodbye World"
...
def rotate_right(input, count):
    ...
    """
    p1 = input[0:-count]
    p2 = input[-count:len(input)+1]
    return p2+p1 # replace __ with the code
...
-I have learnt that python strings has many applications
-Slicing and formating of strings is very easy with python
-I have learnt that unlike in C, Stings are immutable in python
"""
