...
def test_module_without_import():
    try:
        module1.greet("jack")
    except NameError as N :   # what specific exception did you get here, replace ___ with that
        print(N)    # print it out and see
        assert True
...
- I have learnt that a module itself is a python program and python treats modules as an object
- Modules are specially used for building large projects where each module performs a specific no. of tasks
-I have learnt the various ways of importing modules, their advantages and disadvantages, also about importing * from a module
"""
