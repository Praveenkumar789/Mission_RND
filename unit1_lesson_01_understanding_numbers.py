...
def test_numbers_arithmetic_operations():
    ...
    #>>> import math
    #>>> help(math.isclose)
    assert math.isclose(2.33, 7/3, abs_tol=0.05), "fix abs_tol so that this assert passes"
...
-I have learnt about two special operators that are not available in c // and **
-in case of negative numbers,// and % works in a different way it finds the next available +ve number in its factor ex -5%2=1 and -5//2=3 because-5=(-3*2+1)while dividing with 2
-I have learn about the applications of isclose() and int() functions
"""